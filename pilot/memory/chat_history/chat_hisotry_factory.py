...
class ChatHistory:
    def __init__(self):
        ...
        self.mem_store_class_map = {
            DuckdbHistoryMemory.store_type: DuckdbHistoryMemory,
            FileHistoryMemory.store_type: FileHistoryMemory,
            DbHistoryMemory.store_type: DbHistoryMemory,
            MemHistoryMemory.store_type: MemHistoryMemory,
        }
